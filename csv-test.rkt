...
;(define-test-suite csv-tests
  ...
  (test-case 
   "string split"
   (let ([str "337316,27.7,34000,73377,9594870,5024327"])
     (check-equal? (length (split-string str ",")) 6 )
     (check-equal? (split-string str ",") (list "337316" "27.7" "34000" "73377" "9594870" "5024327"))))
